...
//dd($data);
                    $id = $this->model->insert(['invoice_id'            => $request->input('invoice_id'),
                                                'check_in'              => $request->input('check_in'),
                                                'check_out'             => $request->input('check_out'),
                                                'rfp_id'                => $request->input('rfp_id'),
                                                'hotel_name'            => $request->input('hotel_name'),
                                                'hotel_add'             => $request->input('hotel_add'),
                                                'hotel_manager'         => $request->input('hotel_manager'),
                                                'email'                 => $request->input('email'),
                                                'phone'                 => $request->input('phone'),
                                                'total_room'            => $request->input('total_room'),
                                                'room_rate'             => $request->input('room_rate'),
                                                'actualized_room_count' => $request->input('actualized_room_count'),
                                                'commissoin_rate'       => $request->input('commissoin_rate'),
                                                'payment_mode'          => $request->input('payment_mode'),
                                                'est_amt_due'           => $request->input('est_amt_due'),
                    ...
                    if (!is_null($request->input('apply'))) {
                        return redirect($this->module . '/' . $request->input('invoice_id') . '/edit?' . $this->returnUrl())->with('message',
                            __('core.note_success'))->with('status', 'success');
                    }
