...
class NotificationController extends Controller {
    ...
    public function __construct() {
        ...
        $this->data = array('pageTitle' => $this->info['title'], 'pageNote' => $this->info['note'], 'pageModule' => 'notification', 'return' => self::returnUrl());
    }
            ...
            switch ($task) {
                default:
                    ...
                    if ($validator->passes()) {
                        ...
                        return redirect($this->module . '/' . $request->input($this->info['key']))->with('message', __('core.note_error'))->with('status', 'error')->withErrors($validator)->withInput();
                    }
                    break;
                case 'delete':
