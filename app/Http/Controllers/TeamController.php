			...
			default:
				...
				if ($validator->passes()) 
				{
					$data = $this->validatePost( $request );
					 $id  = new Team();
					 $id->user_id= $user->id;
                     $id->team_name= $request->input('team_name');
                     $id->first_name  = $request->input('first_name');
                     $id->last_name= $request->input('last_name');
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('team.public.view',$data);			
			}			
		} 
		else {
			...
			return view('team.public.index',$data);	
		}
