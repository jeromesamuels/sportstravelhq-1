...
class HotelamenitiesController extends Controller {
    ...
    public $module = 'hotelamenities';
    static $per_page = '10';
    public function __construct() {
        parent::__construct();
        $this->model = new Hotelamenities();
        $this->info = $this->model->makeInfo($this->module);
        $this->data = array('pageTitle' => $this->info['title'], 'pageNote' => $this->info['note'], 'pageModule' => 'hotelamenities', 'return' => self::returnUrl());
    }
    ...
    function show(Request $request, $id) {
        ...
        public static function display() {
            ...
            $model = new Hotelamenities();
            $info = $model::makeInfo('hotelamenities');
            ...
            if ($mode == 'view') {
                ...
                if ($row) {
                    ...
                    $data['id'] = $id;
                    return view('hotelamenities.public.view', $data);
                }
            } else {
                ...
                return view('hotelamenities.public.index', $data);
            }
        }
