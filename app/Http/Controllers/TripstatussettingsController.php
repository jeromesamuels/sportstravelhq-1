...
class TripstatussettingsController extends Controller {
    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'tripstatussettings';
    static $per_page = '10';
    public function __construct() {
        parent::__construct();
        $this->model = new Tripstatussettings();
        $this->info = $this->model->makeInfo($this->module);
        $this->data = array('pageTitle' => $this->info['title'], 'pageNote' => $this->info['note'], 'pageModule' => 'tripstatussettings', 'return' => self::returnUrl());
    }
    ...
    function show(Request $request, $id) {
        ...
        public static function display() {
            ...
            $model = new Tripstatussettings();
            $info = $model::makeInfo('tripstatussettings');
            ...
            if ($mode == 'view') {
                ...
                if ($row) {
                    ...
                    $data['id'] = $id;
                    return view('tripstatussettings.public.view', $data);
                }
            } else {
                $page = isset($_GET['page']) ? $_GET['page'] : 1;
                $params = array('page' => $page, 'limit' => (isset($_GET['rows']) ? filter_var($_GET['rows'], FILTER_VALIDATE_INT) : 10), 'sort' => $info['key'], 'order' => 'asc', 'params' => '', 'global' => 1);
                ...
                return view('tripstatussettings.public.index', $data);
            }
        }
