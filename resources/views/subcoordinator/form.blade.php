		...
		<div class="col-md-6">
			  ...
			  <div class="form-group  " >
				...
				<div class="col-md-6">
				  ...
				  {{ Form::select('group_id', [ '4' => 'Travel Coordinator'], $row['group_id'], ['id' => 'group_id', 'class' => 'select2 -- form-control input-sm select2-hidden-accessible']) }}
			  ...
			  <div class="form-group  " >
               ...
               <div class="form-group  " >
				...
				<div class="col-md-6">
				  {!! Form::number('phone_number', $row['phone_number'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true' )) !!} 
				 </div> 
				 <div class="col-md-2">
				...
				<div class="col-md-6">
				  {!! Form::text('address', $row['address'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true' )) !!} 
				 </div> 
				 <div class="col-md-2">
			   ...
			   <div class="form-group  " >
				<label for="Address" class=" control-label col-md-4 text-left"> State<span class="asterix"> * </span></label>
				<div class="col-md-6">
				  {!! Form::text('state', $row['state'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true' )) !!} 
				 </div> 
				 <div class="col-md-2">
				...
				<div class="col-md-6">
				  {!! Form::text('city', $row['city'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true' )) !!} 
				 </div> 
				 <div class="col-md-2">
				...
				<div class="col-md-6">
				  {!! Form::number('zip', $row['zip'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true' )) !!} 
				 </div> 
				 <div class="col-md-2">
			   ...
			   <div class="form-group" style="display: none;">
				<label for="hotel_id" class=" control-label col-md-4 text-left"> Hotel id</label>
				<div class="col-md-6">
