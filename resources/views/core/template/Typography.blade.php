                ...
                <div class="block">
                    ...
                    <div class="well">
                        <ul class="icons-list">
                            ...
                            <li>
                                <i class="icon-list"></i>Nulla volutpat aliquam velit
                                <ul>
                                    <li>Phasellus iaculis neque</li>
                                    <li>Purus sodales ultricies</li>
                                </ul>
                ...
                <div class="block">
                    ...
                    <div class="well">
                        <ul class="icons-list">
                            ...
                            <li>
                                <a data-target="#collapsible-submenu" data-toggle="collapse"><i class="icon-grin"></i> Nulla volutpat aliquam velit</a>
