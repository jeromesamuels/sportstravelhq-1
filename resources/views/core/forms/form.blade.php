                ...
                <div class="col-md-3">
                    <fieldset>
                        ...
                        <div class="form-group  methodstore" >
                            ...
                            <div class=''>
                                <input type='radio' name='method' value ='table' required @if($row['method'] == 'table') checked="checked" @endif class="minimal-red"> <label>Database</label> 
                            </div>
                            <div class=''>
                                <input type='radio' name='method' value ='email' required @if($row['method'] == 'email') checked="checked" @endif class="minimal-red"> <label> Send To Email </label> 
                            </div>
                        </div>
