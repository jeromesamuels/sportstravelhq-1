        ...
        @foreach ($trips as $trip)
            ...
            @if($trip->rfps->count() == 0)
                <tr style="border-bottom-style: dashed;border-color: #eee;">
                    ...
                    <td>
                        <img src="{{ URL('/uploads/users/' . $trip->tripuser->avatar) }}"
                             border="0" width="40" height="40" class="img-circle"
                             style="margin-right:5px;">
                        {{ $trip->tripuser->first_name }}
                        {{ $trip->tripuser->last_name }}
                    </td>
                    <td>
                        {{ date('d-M-Y', strtotime($trip->added)) }}
                    </td>
                    ...
                    <td>
                        @if($trip->status==0)
                            ...
                            <div class="dropdown trips-dropdown-new">
                                <a href="#" style="color: #5dbbe0;font-weight: bold;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-down"
                    ...
                    <td>
                        <div class="dropdown trips-dropdown">
                            ...
                            <a href="#" style="color: #5dbbe0;font-weight: bold;" class="dropdown-toggle" data-toggle="dropdown">View Trip <i class="fa fa-chevron-down"
                                                                                                                                              aria-hidden="true"
                                                                                                                                              style="color: #000;padding-top: 5px;padding-left: 5px;"></i></a>
            ...
            @foreach ($trip->rfps as $rfp)
                <tr style="border-bottom-style: dashed;border-color: #eee;">
                    ...
                    <td>
                        ...
                        <img src="{{ URL('/uploads/users') }}/<?php echo $rfp->usertripInfo->tripuser->avatar;?>" border="0" width="40" height="40" class="img-circle"
                             style="margin-right:5px;"> {{ $rfp->usertripInfo->tripuser->first_name }} {{ $rfp->usertripInfo->tripuser->last_name }}
                    ...
                    <td>
                        ...
                        <div class="dropdown trips-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @if ($rfp->status!= 4)
                                    <li><a href="#confirm_decline" class="btn btn-light" id="custId2" data-toggle="modal" data-id="{{ $rfp->id }}" title="{{ $rfp->id }}"> Declined
                                            RFP</a></li>
                                @else
                                    <li>
                                        <button class="btn btn-light" id="custId2" data-toggle="modal" data-id="{{ $rfp->id }}" title="{{ $rfp->id }}" disabled=""> Declined RFP
                                        </button>
                                    </li>
                                @endif

                                @if ($rfp->status!= 4 && $rfp->status== 8)
                                    <li><a href="#myModal" class="btn btn-light" id="custId_new" data-toggle="modal" data-id="{{ $rfp->id }}" title="{{ $rfp->id }}"> Complete
                                            business </a></li>
                                @else
                                    <li>
                                        <button class="btn btn-light" id="custId_new" data-id="{{ $rfp->id }}" title="{{ $rfp->id }}" disabled="">Complete business</button>
                                    </li>
                                @endif

                                @if ($rfp->status== 4)
                                    <li><a href="{{ route('downloadReceipt',['download'=>'pdf', 'rfp_id' => $rfp->id]) }}">
                                            <button id="download_receipt" title="{{ $rfp->id }}" class="btn btn-light ">Download Receipt</button>
                                        </a></li>
                                @else
                                    <li>
                                        <button title="{{ $rfp->id }}" class="btn btn-light " disabled="">Download Receipt</button>
                                    </li>
                                @endif
                            </ul>
                        </div>
