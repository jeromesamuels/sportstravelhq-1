                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php //echo "id=".$row->id; ?>
                                            <li><a href="{{ url('corporate/user/'.$row->id.'?return='.$return)}}" class="tips" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>
                                            @endif
                                            @if($access['is_edit'] ==1)
                                            <li><a  href="{{ url('corporate/user/'.$row->id.'/edit?return='.$return) }}" class="tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
                                            @endif
