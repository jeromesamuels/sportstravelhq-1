    ...
    <div class="page-content-wrapper no-margin">
        <div class="sbox">
            ...
            <div class="sbox-content">
                ...
                <?php //dd($row['email']); ?>
                {!! Form::open(array('url'=>'corporate/user?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group  " >
                        ...
                        <div class="col-md-6">
                            {{ Form::select('group_id', ['6' => 'Corporate'], $row['group_id'], ['id' => 'group_id', 'class' => 'select2 -- form-control input-sm select2-hidden-accessible']) }}
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
                    <div class="form-group choose_hotel_dd  hide" style="display:none;" >
                    ...
                    <div class="form-group  " >
                     ...
                     <div class="form-group  " >
                        ...
                        <div class="col-md-6">
                            {!! Form::text('phone_number', $row['phone_number'],array('class'=>'form-control  input-sm', 'placeholder'=>'', 'required'=>'true', )) !!} 
                        </div>
                        <div class="col-md-2">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">	
                        ...
                        <button type="button" onclick="location.href='{{ URL::to('corporate/user?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
                    </div>
                </div>
