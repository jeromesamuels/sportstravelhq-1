...
<div class="sbox  " style="border-top: none">
    ...
    <div class="sbox-content"> 
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="spanel">
                    <div class="panel-heading"> Radar type chart </div>
            ...
            <div class="col-lg-4">
                <div class="spanel">
                    <div class="panel-heading"> Doughnut bar chart </div>
                    <div class="panel-body">
                        <div>
            ...
            <div class="col-lg-4">
                <div class="spanel">
                    <div class="panel-heading"> Polar type chart </div>
                    <div class="panel-body">
                        <div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="spanel">
            <div class="panel-heading"> Line type chart </div>
            <div class="panel-body">
                <div>
    ...
    <div class="col-lg-6">
        <div class="spanel">
            <div class="panel-heading">  Bar type chart </div>
            <div class="panel-body">
                <div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="spanel">
            <div class="panel-heading">Single Bar type chart</div>
            <div class="panel-body">
                <div>
    ...
    <div class="col-lg-6">
        <div class="spanel">
            <div class="panel-heading"> Line type chart without curve </div>
            <div class="panel-body">
                <div>
