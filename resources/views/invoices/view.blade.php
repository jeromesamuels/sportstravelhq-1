                ...
                <div class="table-responsive">
                    <table class="table table-striped " >
                        <tbody>
                            ...
                            <tr>
                                <td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Hotel Name', (isset($fields['hotel_name']['language'])? $fields['hotel_name']['language'] : array())) }}</td>
                                <td>{{ $row->hotel_name}} </td>
                            </tr>
                            <tr>
                                <td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Hotel Address', (isset($fields['hotel_add']['language'])? $fields['hotel_add']['language'] : array())) }}</td>
                                <td>{{ $row->hotel_add}} </td>
                            </tr>
                            <tr>
