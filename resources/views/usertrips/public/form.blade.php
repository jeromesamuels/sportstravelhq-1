...
<div class="col-md-6 left-section" >
    ...
    <div class="form-group" >
        ...
        <div class="col-md-11">
            <input  type='text' autocomplete='off' name='trip_name' id='trip_name' value='{{ $row['trip_name'] }}' required placeholder="10/24/19 - Tampa, Fl - 3 Nights" class='form-control input-sm ' /> 
        </div>
    </div>
    <div class="form-group " >
